      ...
      <section className="py-20">
        <div className="section-shell grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          <article className="media-card p-6 sm:p-8">
            <p className="text-xs font-black uppercase tracking-[0.22em] text-red-500">Featured Article</p>
            ...
            <div className="mt-8 flex flex-wrap gap-3 text-xs font-black uppercase tracking-[0.16em] text-zinc-400">
              <span className="border border-red-500/40 bg-red-500/10 px-3 py-2 text-red-500">{featuredArticle.category}</span>
      ...
      <section className="border-y hairline bg-white/[0.025] py-16">
        <div className="section-shell">
          <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="text-sm font-black uppercase tracking-[0.25em] text-red-500">Article Grid</p>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {latestNews.map((article) => (
              <article key={article.title} className="media-card p-6">
                <p className="text-xs font-black uppercase tracking-[0.2em] text-red-500">{article.category}</p>
